"""Provider override data classes for the LightRAG baseline.

The field names intentionally mirror the Microsoft baseline, but this module
has no GraphRAG dependency so the LightRAG client remains independently
importable.
"""
